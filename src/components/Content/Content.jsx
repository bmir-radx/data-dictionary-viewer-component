...
function Content({activeView, variables, searchTerm}) {
    ...
    const [filters, setFilters] = useState({'Section': [], 'Datatype': [], 'Cardinality': [], 'Unit': []});
    ...
    return (
        <div className={classes.content}>
            ...
            <ListView activeView={activeView} variables={searchFilteredVariables} searchTerm={searchTerm} />
            <TableView activeView={activeView} variables={valueFilteredVariables} allValues={allValues} filteredValues={filteredValues} searchTerm={searchTerm} filters={filters} setFilters={setFilters} />
        </div>
    )
}
